...
if __name__ == '__main__':
    setup(
        ...
        ext_modules=[
            ...
            CUDAExtension(
                name='det3d.core.roiaware_pool3d.roiaware_pool3d_cuda',
                sources=[
                    'det3d/core/roiaware_pool3d/src/roiaware_pool3d.cpp',
                    'det3d/core/roiaware_pool3d/src/roiaware_pool3d_kernel.cu',
                ],
                extra_compile_args={'cxx': ['-g', '-I /usr/local/cuda/include'],
                                    'nvcc': ['-O2']},
            )
